...
#include "02_SceneHelloTriangleIndexed.h"
...
SceneHelloTriangleIdx::SceneHelloTriangleIdx()
        : Scene(StaticName())
{
    // shader setup
    // vertex shader
...
void SceneHelloTriangleIdx::OnUpdate(double delta_time) { }

void SceneHelloTriangleIdx::OnRender()
{
...
void SceneHelloTriangleIdx::OnImGuiRender() { }

REGISTER_SCENE(SceneHelloTriangleIdx);